...
An example [camel-activemq application](https://github.com/wildfly-extras/wildfly-camel/tree/2.3.0/examples/projects/camel-activemq) is available on GitHub.
